...
qq.DragAndDrop=function(a){function b(){k===o&&!i&&(f.callbacks.log("Grabbed "+l.length+" files after tree traversal."),m.dropDisabled(!1),f.callbacks.dropProcessing(!1,l))}function c(a){var d;k+=1;a.isFile?a.file(function(a){l.push(a);o+=1;b()}):a.isDirectory&&(i=!0,a=a.createReader(),a.readEntries(function(a){o+=1;for(d=0;d<a.length;d+=1)c(a[d]);i=!1;a.length||b()}))}function d(a){m=new qq.UploadDropZone({element:a,onEnter:function(b){qq(a).addClass(f.classes.dropActive);b.stopPropagation()},onLeaveNotDescendants:function(){qq(a).removeClass(f.classes.dropActive)},
onDrop:function(d){f.hideDropzones&&qq(a).hide();qq(a).removeClass(f.classes.dropActive);var d=d.dataTransfer,e,g;f.callbacks.dropProcessing(!0);m.dropDisabled(!0);if(1<d.files.length&&!f.multiple)f.callbacks.dropProcessing(!1),f.callbacks.error("tooManyFilesError",""),m.dropDisabled(!1);else if(l=[],o=k=0,qq.isFolderDropSupported(d)){e=d.items;for(d=0;d<e.length;d+=1)if(g=e[d].webkitGetAsEntry())g.isFile?(l.push(e[d].getAsFile()),d===e.length-1&&b()):c(g)}else f.callbacks.dropProcessing(!1,d.files),
m.dropDisabled(!1)}});s.addDisposer(function(){m.dispose()});f.hideDropzones&&qq(a).hide()}function e(a){var b;qq.each(a.dataTransfer.types,function(a,c){if("Files"===c)return b=!0,!1});return b}function g(){f.dropArea&&f.extraDropzones.push(f.dropArea);var a,b=f.extraDropzones;for(a=0;a<b.length;a+=1)d(b[a]);f.dropArea&&(!qq.ie()||qq.ie10())&&s.attach(document,"dragenter",function(c){if(!m.dropDisabled()&&e(c)&&!qq(f.dropArea).hasClass(f.classes.dropDisabled)){f.dropArea.style.display="block";for(a=
0;a<b.length;a+=1)b[a].style.display="block"}});s.attach(document,"dragleave",function(c){if(f.hideDropzones&&qq.FineUploader.prototype._leaving_document_out(c))for(a=0;a<b.length;a+=1)qq(b[a]).hide()});s.attach(document,"drop",function(c){if(f.hideDropzones)for(a=0;a<b.length;a+=1)qq(b[a]).hide();c.preventDefault()})}var f,m,i,l=[],k=0,o=0,s=new qq.DisposeSupport;f={dropArea:null,extraDropzones:[],hideDropzones:!0,multiple:!0,classes:{dropActive:null},callbacks:{dropProcessing:function(){},error:function(){},
log:function(){}}};qq.extend(f,a);return{setup:function(){g()},setupExtraDropzone:function(a){f.extraDropzones.push(a);d(a)},removeExtraDropzone:function(a){var b,c=f.extraDropzones;for(b in c)if(c[b]===a)return c.splice(b,1)},dispose:function(){s.dispose();m.dispose()}}};
qq.UploadDropZone=function(a){function b(){return qq.safari()||qq.firefox()&&qq.windows()}function c(a){if(qq.ie()&&!qq.ie10())return!1;var b=a.dataTransfer,c=qq.safari(),a=qq.ie10()?!0:"none"!==b.effectAllowed;return b&&a&&(b.files||!c&&b.types.contains&&b.types.contains("Files"))}function d(a){void 0!==a&&(f=a);return f}var e,g,f,m,i=new qq.DisposeSupport;e={element:null,onEnter:function(){},onLeave:function(){},onLeaveNotDescendants:function(){},onDrop:function(){}};qq.extend(e,a);g=e.element;
(function(){m||(b?i.attach(document,"dragover",function(a){a.preventDefault()}):i.attach(document,"dragover",function(a){a.dataTransfer&&(a.dataTransfer.dropEffect="none",a.preventDefault())}),m=!0)})();(function(){i.attach(g,"dragover",function(a){if(c(a)){var b=qq.ie()?null:a.dataTransfer.effectAllowed;a.dataTransfer.dropEffect="move"===b||"linkMove"===b?"move":"copy";a.stopPropagation();a.preventDefault()}});i.attach(g,"dragenter",function(a){if(!d()&&c(a))e.onEnter(a)});i.attach(g,"dragleave",
...
arguments))}});
qq.AjaxRequestor=function(a){function b(a){var b=qq.indexOf(i,a),d=k.maxConnections;delete l[a];i.splice(b,1);i.length>=d&&b<d&&(a=i[d-1],c(a))}function c(a){var b=new XMLHttpRequest,c=g(),i={},r;k.onSend(a);k.paramsStore.getParams&&(i=k.paramsStore.getParams(a));r=i;var t=k.endpointStore.getEndpoint(a),z=l[a].addToPath;void 0!==z&&(t+="/"+z);r=m&&r?qq.obj2url(r,t):t;l[a].xhr=b;b.onreadystatechange=d(a);b.open(c,r,!0);k.cors.expected&&k.cors.sendCredentials&&(b.withCredentials=!0);e(a);f("Sending "+
c+" request for "+a);!m&&i?b.send(qq.obj2url(i,"")):b.send()}function d(a){var c=l[a].xhr;return function(){if(4===c.readyState){var d=l[a].xhr,e=g(),i=!1;b(a);0<=qq.indexOf(k.successfulResponseCodes,d.status)||(i=!0,f(e+" request for "+a+" has failed - response code "+d.status,"error"));k.onComplete(a,d,i)}}}function e(a){var b=l[a].xhr,a=k.customHeaders;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,c){b.setRequestHeader(a,
c)})}function g(){return k.demoMode?"GET":k.method}var f,m,i=[],l=[],k={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(k,a);f=k.log;m="GET"===g()||"DELETE"===g();return{send:function(a,b){l[a]={addToPath:b};i.push(a)<=k.maxConnections&&c(a)},cancel:function(a){var c=l[a].xhr,d=g();c?(c.onreadystatechange=
...
qq.UploadHandlerForm=function(a,b,c){function d(a){void 0!==o[a]&&(o[a](),delete o[a])}function e(a,b){var c=a.id;r[k[c]]=b;o[c]=qq(a).attach("load",function(){l[c]&&(q("Received iframe load event for CORS upload request (file id "+c+")"),s[c]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+c;q(a,"error");b({error:a})},1E3))});x.receiveMessage(c,function(a){q("Received the following window message: '"+a+"'");var b=qq.parseJson(a),e=b.uuid;e&&r[e]?(clearTimeout(s[c]),
delete s[c],d(c),a=r[e],delete r[e],x.stopReceivingMessages(c),a(b)):e||q("'"+a+"' does not contain a UUID - ignoring.")})}function g(a,b){i.cors.expected?e(a,b):o[a.id]=qq(a).attach("load",function(){q("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(c){q("Error when attempting to access iframe during handling of upload response ("+c+")","error")}b()}})}function f(a){var b=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');b.setAttribute("id",a);b.style.display="none";document.body.appendChild(b);return b}function m(a,b){var c=i.paramsStore.getParams(a),d=qq.toElement('<form method="'+(i.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),e=i.endpointStore.getEndpoint(a),g=e;c[i.uuidParamName]=k[a];i.paramsInBody?qq.obj2Inputs(c,d):g=qq.obj2url(c,e);d.setAttribute("action",g);d.setAttribute("target",b.name);d.style.display="none";document.body.appendChild(d);return d}var i=a,l=[],k=[],o={},s=
{},q=c,x=new qq.WindowReceiveMessage({log:q}),r={},t;return t={add:function(a){a.setAttribute("name",i.inputName);var b=l.push(a)-1;k[b]=qq.getUniqueId();a.parentNode&&qq(a).remove();return b},getName:function(a){return l[a].value.replace(/.*(\/|\\)/,"")},isValid:function(a){return void 0!==l[a]},reset:function(){qq.UploadHandler.prototype.reset.apply(this,arguments);l=[];k=[];o={}},getUuid:function(a){return k[a]},cancel:function(a){i.onCancel(a,this.getName(a));delete l[a];delete k[a];delete o[a];
i.cors.expected&&(clearTimeout(s[a]),delete s[a],x.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var c=l[a],e=t.getName(a),k=f(a),h;if(!c)throw Error("file with passed id was not added, or already uploaded or cancelled");i.onUpload(a,this.getName(a));h=m(a,k);h.appendChild(c);g(k,function(c){q("iframe loaded");if(!c){var h;try{var g=k.contentDocument||k.contentWindow.document,f=g.body.innerHTML;
q("converting iframe's innerHTML to JSON");q("innerHTML = "+f);f&&f.match(/^<pre/i)&&(f=g.body.firstChild.firstChild.nodeValue);h=qq.parseJson(f)}catch(j){q("Error when attempting to parse form upload response ("+j+")","error"),h={success:!1}}c=h}d(a);i.cors.expected||qq(k).remove();if(c.success||!i.onAutoRetry(a,e,c))i.onComplete(a,e,c),b(a)});q("Sending upload request for "+a);h.submit();qq(h).remove();return a}}};
...
c):e.webkitSlice&&(i=e.webkitSlice(f,c));return{part:b,start:f,end:c,count:d,blob:i,size:c-f}}function g(a){a=p.getSize(a);return Math.ceil(a/j.chunking.partSize)}function f(a){var b=new XMLHttpRequest;return h[a].xhr=b}function m(a,b,c,d){var e=new FormData,g=j.demoMode?"GET":"POST",f=j.endpointStore.getEndpoint(d),i=f,k=p.getName(d),l=p.getSize(d),m=h[d].blobData;a[j.uuidParamName]=h[d].uuid;w&&(a[j.totalFileSizeParamName]=l,m&&(a[j.blobs.paramNames.name]=m.name));j.paramsInBody||(w||(a[j.inputName]=
k),i=qq.obj2url(a,f));b.open(g,i,!0);j.cors.expected&&j.cors.sendCredentials&&(b.withCredentials=!0);return w?(j.paramsInBody&&qq.obj2FormData(a,e),e.append(j.inputName,c),e):c}function i(a,b){var c=j.customHeaders,d=h[a].file||h[a].blobData.blob;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");w||(b.setRequestHeader("Content-Type","application/octet-stream"),b.setRequestHeader("X-Mime-Type",d.type));qq.each(c,function(a,c){b.setRequestHeader(a,
c)})}function l(a,b,c){var d=p.getName(a),e=p.getSize(a);h[a].attemptingResume=!1;j.onProgress(a,d,e,e);j.onComplete(a,d,b,c);delete h[a].xhr;B(a)}function k(a){var b=h[a].remainingChunkIdxs[0],c=e(a,b),g=f(a),k=p.getSize(a),l=p.getName(a),n;void 0===h[a].loaded&&(h[a].loaded=0);v&&h[a].file&&x(a,c);g.onreadystatechange=q(a,g);g.upload.onprogress=function(c){if(c.lengthComputable){var d=c.loaded+h[a].loaded,c=c.total,g=e(a,b),c=c-g.size,f=p.getSize(a),g=g.count,i=c-h[a].initialRequestOverhead;h[a].lastRequestOverhead=
c;if(b===0){h[a].lastChunkIdxProgress=0;h[a].initialRequestOverhead=c;h[a].estTotalRequestsSize=f+g*c}else if(h[a].lastChunkIdxProgress!==b){h[a].lastChunkIdxProgress=b;h[a].estTotalRequestsSize=h[a].estTotalRequestsSize+i}j.onProgress(a,l,d,h[a].estTotalRequestsSize)}};j.onUploadChunk(a,l,s(c));n=j.paramsStore.getParams(a);d(a,n,c);h[a].attemptingResume&&(n[j.resume.paramNames.resuming]=!0);n=m(n,g,c.blob,a);i(a,g);u("Sending chunked upload request for item "+a+": bytes "+(c.start+1)+"-"+c.end+" of "+
k);g.send(n)}function o(a){u("Server has ordered chunking effort to be restarted on next attempt for item ID "+a,"error");v&&(r(a),h[a].attemptingResume=!1);h[a].remainingChunkIdxs=[];delete h[a].loaded;delete h[a].estTotalRequestsSize;delete h[a].initialRequestOverhead}function s(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function q(a,b){return function(){if(4===b.readyState){var c;if(h[a]){u("xhr - server response received for "+a);u("responseText = "+b.responseText);
try{c=qq.parseJson(b.responseText)}catch(d){u("Error when attempting to parse xhr response text ("+d+")","error"),c={}}if(200!==b.status||!c.success||c.reset)if(c.reset&&o(a),h[a].attemptingResume&&c.reset)h[a].attemptingResume=!1,u("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),o(a),p.upload(a,!0);else{var g=p.getName(a);j.onAutoRetry(a,g,c,b)||l(a,c,b)}else if(A){var g=h[a].remainingChunkIdxs.shift(),f=e(a,g);h[a].attemptingResume=!1;
var g=h[a],i=g.loaded,f=f.size,m;m=w?h[a].lastRequestOverhead:0;g.loaded=i+(f+m);0<h[a].remainingChunkIdxs.length?k(a):(v&&r(a),l(a,c,b))}else l(a,c,b)}}}}function x(a,b){var c=p.getUuid(a),d=h[a].loaded,e=h[a].initialRequestOverhead,g=h[a].estTotalRequestsSize,f=t(a);qq.setCookie(f,c+n+b.part+n+d+n+e+n+g,j.resume.cookiesExpireIn)}function r(a){h[a].file&&(a=t(a),qq.deleteCookie(a))}function t(a){var b=p.getName(a),a=p.getSize(a),c=j.chunking.partSize,b="qqfilechunk"+n+encodeURIComponent(b)+n+a+n+
c;void 0!==y&&(b+=n+y);return b}function z(a){var b=h[a].file||h[a].blobData.blob,c=p.getName(a),d,e;h[a].loaded=0;d=f(a);d.upload.onprogress=function(b){b.lengthComputable&&(h[a].loaded=b.loaded,j.onProgress(a,c,b.loaded,b.total))};d.onreadystatechange=q(a,d);e=j.paramsStore.getParams(a);b=m(e,d,b,a);i(a,d);u("Sending upload request for "+a);d.send(b)}var j=a,B=b,u=c,h=[],n="|",A=j.chunking.enabled&&qq.isFileChunkingSupported(),v=j.resume.enabled&&A&&qq.areCookiesEnabled(),y;y=null!==j.resume.id&&
...
getSize:function(a){a=h[a].file||h[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(h[a])return h[a].file||h[a].blobData.blob},getLoaded:function(a){return h[a].loaded||0},isValid:function(a){return void 0!==h[a]},reset:function(){h=[]},getUuid:function(a){return h[a].uuid},upload:function(a,b){var c=this.getName(a);j.onUpload(a,c);if(A){var d=p.getName(a),c=0,f,i;if(!h[a].remainingChunkIdxs||0===h[a].remainingChunkIdxs.length){h[a].remainingChunkIdxs=
[];if(v&&!b&&h[a].file){a:{f=qq.getCookie(t(a));i=p.getName(a);var l,m,o;if(f){f=f.split(n);if(5===f.length){i=f[0];l=parseInt(f[1],10);m=parseInt(f[2],10);o=parseInt(f[3],10);f=parseInt(f[4],10);f={uuid:i,part:l,lastByteSent:m,initialRequestOverhead:o,estTotalRequestsSize:f};break a}u("Ignoring previously stored resume/chunk cookie for "+i+" - old cookie format","warn")}f=void 0}f&&(i=e(a,f.part),!1!==j.onResume(a,d,s(i))&&(c=f.part,h[a].uuid=f.uuid,h[a].loaded=f.lastByteSent,h[a].estTotalRequestsSize=
f.estTotalRequestsSize,h[a].initialRequestOverhead=f.initialRequestOverhead,h[a].attemptingResume=!0,u("Resuming "+d+" at partition index "+c)))}for(d=g(a)-1;d>=c;d-=1)h[a].remainingChunkIdxs.unshift(d)}k(a)}else z(a)},cancel:function(a){var b=h[a].xhr;j.onCancel(a,this.getName(a));b&&(b.onreadystatechange=null,b.abort());v&&r(a);delete h[a]},getResumableFilesData:function(){var a=[],b=[];return A&&v?(a=void 0===y?qq.getCookieNames(RegExp("^qqfilechunk\\"+n+".+\\"+n+"\\d+\\"+n+j.chunking.partSize+
"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+n+".+\\"+n+"\\d+\\"+n+j.chunking.partSize+"\\"+n+y+"=")),qq.each(a,function(a,c){var d=c.split(n),e=qq.getCookie(c).split(n);b.push({name:decodeURIComponent(d[1]),size:d[2],uuid:e[0],partIdx:e[1]})}),b):[]}}};